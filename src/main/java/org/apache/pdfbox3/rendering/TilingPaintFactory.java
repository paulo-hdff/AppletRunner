...
{
    private static final Logger LOG = Logger.getLogger(TilingPaintFactory.class.getName());
    ...
    private static class TilingPaintParameter
    {
        ...
        public boolean equals(Object obj)
        {
            ...
            {
                LOG.log(Level.FINER,"Couldn't convert color to RGB - treating as not equal", ex);
                return false;
            }
