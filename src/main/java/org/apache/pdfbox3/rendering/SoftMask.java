...
import org.apache.pdfbox3.pdmodel.common.function.PDFunctionTypeIdentity;
...
class SoftMask implements Paint
{
    ...
    private static final Logger LOG = Logger.getLogger(SoftMask.class.getName());
    ...
    SoftMask(Paint paint, BufferedImage mask, Rectangle2D bboxDevice, PDColor backdropColor, PDFunction transferFunction)
    {
        ...
        if (backdropColor != null)
        {
            ...
            {
                // keep default
                LOG.log(Level.FINER,"Couldn't convert backdropColor to RGB - keeping default", ex);
            }
        }
    }
                    ...
                    if (x1 + x >= 0 && y1 + y >= 0 && x1 + x < mask.getWidth() && y1 + y < mask.getHeight())
                    {
                        ...
                        if (transferFunction != null)
                        {
                            ...
                            catch (IOException ex)
                            {
                                ...
                                LOG.log(Level.FINER,"Couldn't apply transferFunction - treating as outside", ex);
