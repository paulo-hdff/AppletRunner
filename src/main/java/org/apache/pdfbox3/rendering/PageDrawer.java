...
import org.apache.pdfbox3.pdmodel.common.function.PDFunction;
import org.apache.pdfbox3.pdmodel.documentinterchange.markedcontent.PDPropertyList;
import org.apache.pdfbox3.pdmodel.font.PDFont;
import org.apache.pdfbox3.pdmodel.font.PDType3Font;
import org.apache.pdfbox3.pdmodel.font.PDVectorFont;
import org.apache.pdfbox3.pdmodel.graphics.PDLineDashPattern;
import org.apache.pdfbox3.pdmodel.graphics.PDXObject;
import org.apache.pdfbox3.pdmodel.graphics.blend.BlendMode;
import org.apache.pdfbox3.pdmodel.graphics.color.PDColor;
...
import org.apache.pdfbox3.pdmodel.graphics.color.PDPattern;
import org.apache.pdfbox3.pdmodel.graphics.color.PDSeparation;
import org.apache.pdfbox3.pdmodel.graphics.form.PDFormXObject;
import org.apache.pdfbox3.pdmodel.graphics.form.PDTransparencyGroup;
import org.apache.pdfbox3.pdmodel.graphics.image.PDImage;
import org.apache.pdfbox3.pdmodel.graphics.image.PDImageXObject;
import org.apache.pdfbox3.pdmodel.graphics.optionalcontent.PDOptionalContentGroup;
import org.apache.pdfbox3.pdmodel.graphics.optionalcontent.PDOptionalContentGroup.RenderState;
import org.apache.pdfbox3.pdmodel.graphics.optionalcontent.PDOptionalContentMembershipDictionary;
import org.apache.pdfbox3.pdmodel.graphics.pattern.PDAbstractPattern;
import org.apache.pdfbox3.pdmodel.graphics.pattern.PDShadingPattern;
import org.apache.pdfbox3.pdmodel.graphics.pattern.PDTilingPattern;
import org.apache.pdfbox3.pdmodel.graphics.shading.PDShading;
import org.apache.pdfbox3.pdmodel.graphics.state.PDExtendedGraphicsState;
import org.apache.pdfbox3.pdmodel.graphics.state.PDGraphicsState;
import org.apache.pdfbox3.pdmodel.graphics.state.PDSoftMask;
import org.apache.pdfbox3.pdmodel.graphics.state.RenderingMode;
import org.apache.pdfbox3.pdmodel.interactive.annotation.AnnotationFilter;
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAnnotation;
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAnnotationUnknown;
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAppearanceDictionary;
import org.apache.pdfbox3.util.Matrix;
import org.apache.pdfbox3.util.Vector;
...
public class PageDrawer extends PDFGraphicsStreamEngine
{
    ...
    */
    ...
    protected Paint getPaint(PDColor color) throws IOException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if (shading == null)
                {
                    LOG.log(Level.SEVERE,"shadingPattern is null, will be filled with transparency");
                    return new Color(0,0,0,0);
                }
    ...
    private Stroke getStroke()
    {
        ...
        if (miterLimit < 1)
        {
            LOG.log(Level.WARNING,"Miter limit must be >= 1, value " + miterLimit + " is ignored");
            miterLimit = 10;
        }
    ...
    public void shadingFill(COSName shadingName) throws IOException
    {
        ...
        if (shading == null)
        {
            LOG.log(Level.SEVERE,"shading " + shadingName + " does not exist in resources dictionary");
            return;
        }
        Matrix ctm = getGraphicsState().getCurrentTransformationMatrix();
        ...
        throws IOException
    {
        ...
        else
        {
            ...
            {
                LOG.log(Level.SEVERE,"Exception drawing image, see JDK-6689349, " +
    ...
    private final class TransparencyGroup
    {
                ...
                PDColor backdropColor) throws IOException
        {
            ...
            if (formBBox == null)
            {
                ...
                LOG.log(Level.WARNING,"transparency group ignored because BBox is null");
        ...
        private boolean isGray(PDColorSpace colorSpace)
        {
            ...
            if (colorSpace instanceof PDICCBased)
            {
                ...
                {
                    LOG.log(Level.FINER,"Couldn't get an alternate ColorSpace", ex);
                    return false;
                }
            }
            return false;
