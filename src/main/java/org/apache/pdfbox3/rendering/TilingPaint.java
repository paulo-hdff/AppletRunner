...
{
    private static final Logger LOG = Logger.getLogger(TilingPaint.class.getName());
    ...
    static 
    {
        ...
        {
            LOG.log(Level.SEVERE,"Default will be used", ex);
    ...
    private Rectangle2D getAnchorRect(PDTilingPattern pattern) throws IOException
    {
        ...
        {
            LOG.log(Level.WARNING,"/XStep is 0, using pattern /BBox width");
            xStep = bbox.getWidth();
        }
        ...
        {
            LOG.log(Level.WARNING,"/YStep is 0, using pattern /BBox height");
