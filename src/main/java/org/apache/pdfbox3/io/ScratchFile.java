...
{
    private static final Logger LOG = Logger.getLogger(ScratchFile.class.getName());;
    ...
    public static ScratchFile getMainMemoryOnlyInstance()
    {
        ...
        catch (IOException ioe)
        {
            ...
            LOG.log(Level.SEVERE,"Unexpected exception occurred creating main memory scratch file instance: " + ioe.getMessage(), ioe);
            return null;
        }
    }
            ...
            if (useScratchFile)
            {
                ...
                if ( raf == null )
                {
                    ...
                    catch (IOException e)
                    {
                        if (!file.delete())
                        {
                            LOG.log(Level.WARNING,"Error deleting scratch file: " + file.getAbsolutePath());
                        }
                        throw e;
                    }
                }
