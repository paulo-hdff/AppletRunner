...
public class PDFunctionType0 extends PDFunction
{
     ...
     * Log instance.
     */
    private static final Logger LOG = Logger.getLogger(PDFunctionType0.class.getName());
    ...
    private class Rinterpol
    {
        ...
        private int[][] getSamples()
        {
            if (samples == null)
            {
                ...
                {
                    LOG.log(Level.SEVERE,"IOException while reading the sample values of this function.", exception);
                }
            }
            return samples;
        }
