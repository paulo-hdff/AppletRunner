...
{
    private static final Logger LOG = Logger.getLogger( PDNumberTreeNode.class.getName());
    ...
    public Object getValue(Integer index) throws IOException
    {
        ...
        {
            LOG.log(Level.WARNING,"NumberTreeNode does not have \"nums\" nor \"kids\" objects.");
        }
        return retval;
    }
    ...
    public Map<Integer,COSObjectable> getNumbers()  throws IOException
    {
        ...
        if (numbersArray != null)
        {
            ...
            {
                LOG.log(Level.WARNING,"Numbers array has odd size: " + numbersArray.size());
            }
