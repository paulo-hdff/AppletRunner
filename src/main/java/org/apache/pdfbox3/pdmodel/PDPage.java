...
import org.apache.pdfbox3.contentstream.PDContentStream;
...
import org.apache.pdfbox3.io.SequenceRandomAccessRead;
...
import org.apache.pdfbox3.pdmodel.interactive.action.PDPageAdditionalActions;
...
import org.apache.pdfbox3.pdmodel.interactive.measurement.PDViewportDictionary;
import org.apache.pdfbox3.pdmodel.interactive.pagenavigation.PDThreadBead;
import org.apache.pdfbox3.pdmodel.interactive.pagenavigation.PDTransition;
...
public class PDPage implements COSObjectable, PDContentStream
{
     ...
     * Log instance
     */
    private static final Logger LOG = Logger.getLogger(PDPage.class.getName());
    ...
    public RandomAccessRead getContentsForRandomAccess() throws IOException
    {
        ...
        if (contentStream != null)
        {
            ...
            {
                LOG.log(Level.WARNING,"skipped malformed content stream");
        ...
        if (array != null)
        {
            ...
            streams.forEach(stream ->
            {
                ...
                {
                    LOG.log(Level.WARNING,"malformed substream of content stream skipped");
                }
            });
    ...
    public PDRectangle getMediaBox()
    {
        if (mediaBox == null)
        {
            ...
            {
                LOG.log(Level.FINER,"Can't find MediaBox, will use U.S. Letter");
     ...
     * {@link PDAnnotation#setPage(org.apache.pdfbox3.pdmodel.PDPage)}. Not doing it
    ...
    public List<PDViewportDictionary> getViewports()
    {
        ...
        for (int i = 0; i < array.size(); ++i)
        {
            ...
            {
                LOG.log(Level.WARNING,"Array element " + base2 + " is skipped, must be a (viewport) dictionary");
            }
        }
        return viewports;
    }
