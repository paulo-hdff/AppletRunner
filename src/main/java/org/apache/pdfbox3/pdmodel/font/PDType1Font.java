...
import org.apache.fontbox3.EncodedFont;
import org.apache.fontbox3.FontBoxFont;
import org.apache.fontbox3.type1.DamagedFontException;
...
import org.apache.pdfbox3.pdmodel.font.encoding.Encoding;
import org.apache.pdfbox3.pdmodel.font.encoding.StandardEncoding;
import org.apache.pdfbox3.pdmodel.font.encoding.Type1Encoding;
import org.apache.pdfbox3.pdmodel.font.encoding.WinAnsiEncoding;
import org.apache.pdfbox3.pdmodel.font.encoding.ZapfDingbatsEncoding;
import org.apache.pdfbox3.util.Matrix;


import static org.apache.pdfbox3.pdmodel.font.UniUtil.getUniNameOfCodePoint;
import org.apache.pdfbox3.pdmodel.font.encoding.SymbolEncoding;
...
{
    private static final Logger LOG = Logger.getLogger(PDType1Font.class.getName());
    ...
    public PDType1Font(FontName baseFont)
    {
        ...
        if (mapping.isFallback())
        {
            ...
            {
                LOG.log(Level.FINER,"Couldn't get font name - setting to '?'", e);
                fontName = "?";
            }
            LOG.log(Level.WARNING,"Using fallback font " + fontName + " for base font " + getBaseFont());
        }
        isEmbedded = false;
        isDamaged = false;
    ...
    public PDType1Font(COSDictionary fontDictionary) throws IOException
    {
        ...
        if (fd != null)
        {
            ...
            if (fontFile3 != null)
            {
                LOG.log(Level.WARNING,"/FontFile3 for Type1 font not supported");
            }
            ...
            if (fontFile != null)
            {
                ...
                {
                    LOG.log(Level.WARNING,"Can't read damaged embedded Type1 font " + fd.getFontName(), e);
                    fontIsDamaged = true;
                }
                catch (IOException e)
                {
                    LOG.log(Level.SEVERE,"Can't read the embedded Type1 font " + fd.getFontName(), e);
                    fontIsDamaged = true;
                }
            }
        }
        ...
        else
        {
            ...
            if (mapping.isFallback())
            {
                LOG.log(Level.WARNING,"Using fallback font " + genericFont.getName() + " for " + getBaseFont());
            }
        }
        readEncoding();
    ...
    private int repairLength1(byte[] bytes, int length1)
    {
        ...
        if (length1 - offset != 0 && offset > 0)
        {
            ...
            {
                LOG.log(Level.WARNING,"Ignored invalid Length1 " + length1 + " for Type 1 font " + getName());
            }
            return offset;
        }
    ...
    private int repairLength2(byte[] bytes, int length1, int length2)
    {
        ...
        {
            LOG.log(Level.WARNING,"Ignored invalid Length2 " + length2 + " for Type 1 font " + getName());
    ...
    public final Matrix getFontMatrix()
    {
        if (fontMatrix == null)
        {
            ...
            {
                LOG.log(Level.FINER,"Couldn't get font matrix box - returning default value", e);
