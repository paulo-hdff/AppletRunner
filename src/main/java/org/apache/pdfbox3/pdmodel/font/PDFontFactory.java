...
{
    private static final Logger LOG = Logger.getLogger(PDFontFactory.class.getName());
    ...
    public static PDFont createFont(COSDictionary dictionary, ResourceCache resourceCache) throws IOException
    {
        ...
        {
            LOG.log(Level.SEVERE,"Expected 'Font' dictionary but found '" + type.getName() + "'");
        }
        ...
        else
        {
            ...
            LOG.log(Level.WARNING,"Invalid font subtype '" + subType + "'");
            return new PDType1Font(dictionary);
        }
    }
