...
{
    private static final Logger LOG = Logger.getLogger(PDCIDFont.class.getName());
    ...
    private void readWidths()
    {
        ...
        if (wArray != null)
        {
            ...
            while (counter < size - 1)
            {
                ...
                {
                    LOG.log(Level.WARNING,"Expected a number array member, got " + firstCodeBase);
                    continue;
                }
                ...
                if (next instanceof COSArray)
                {
                    ...
                    for (int i = 0; i < arraySize; i++)
                    {
                        ...
                        {
                            LOG.log(Level.WARNING,"Expected a number array member, got " + widthBase);
                        }
                    }
                }
                else
                {
                    if (counter >= size)
                    {
                        LOG.log(Level.WARNING,"premature end of widths array");
                        break;
                    }
                    ...
                    {
                        LOG.log(Level.WARNING,"Expected two numbers, got " + secondCodeBase + " and " + rangeWidthBase);
                        continue;
                    }
