...
import org.apache.fontbox3.ttf.HorizontalMetricsTable;
import org.apache.fontbox3.ttf.TrueTypeFont;
import org.apache.fontbox3.ttf.VerticalHeaderTable;
import org.apache.fontbox3.ttf.VerticalMetricsTable;
...
final class PDCIDFontType2Embedder extends TrueTypeEmbedder
{
    ...
    private static final Logger LOG = Logger.getLogger(PDCIDFontType2Embedder.class.getName());
    ...
    private boolean buildVerticalHeader(COSDictionary cidFont) throws IOException
    {
        ...
        if (vhea == null)
        {
            LOG.log(Level.WARNING,"Font to be subset is set to vertical, but has no 'vhea' table");
            return false;
        }
