...
import org.apache.fontbox3.cff.Type2CharString;
import org.apache.fontbox3.ttf.CmapSubtable;
import org.apache.fontbox3.ttf.CmapTable;
import org.apache.fontbox3.ttf.GlyphData;
import org.apache.fontbox3.ttf.GlyphTable;
import org.apache.fontbox3.ttf.OTFParser;
import org.apache.fontbox3.ttf.OpenTypeFont;
import org.apache.fontbox3.ttf.PostScriptTable;
...
import org.apache.pdfbox3.pdmodel.font.encoding.BuiltInEncoding;
import org.apache.pdfbox3.pdmodel.font.encoding.Encoding;
import org.apache.pdfbox3.pdmodel.font.encoding.GlyphList;
import org.apache.pdfbox3.pdmodel.font.encoding.MacOSRomanEncoding;
import org.apache.pdfbox3.pdmodel.font.encoding.MacRomanEncoding;
...
{
    private static final Logger LOG = Logger.getLogger(PDTrueTypeFont.class.getName());
    ...
    public PDTrueTypeFont(COSDictionary fontDictionary) throws IOException
    {
        ...
        if (getFontDescriptor() != null)
        {
            ...
            if (ff2Stream != null)
            {
                ...
                {
                    LOG.log(Level.WARNING,"Could not read embedded TTF for font " + getBaseFont(), e);
                    fontIsDamaged = true;
        ...
        if (ttfFont == null)
        {
            ...
            {
                LOG.log(Level.WARNING,"Using fallback font " + ttfFont + " for " + getBaseFont());
            }
        }
