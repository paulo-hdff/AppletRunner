...
{
    private static final Logger LOG = Logger.getLogger(PDType0Font.class.getName());
    ...
    private void readEncoding() throws IOException
    {
        ...
        else if (encoding != null)
        {
            ...
            {
                LOG.log(Level.WARNING,"Invalid Encoding CMap in font " + getName());
            }
        }
    ...
    private void fetchCMapUCS2() throws IOException
    {
            ...
            isDescendantCJK)
        {
            ...
            if (strName != null)
            {
                ...
                {
                    LOG.log(Level.WARNING,"Could not get " + strName + " UC2 map for font " + getName(), ex);
                }
            }
        }
    }
    ...
    public String toUnicode(int code)
    {
        ...
        if (descendantFont instanceof PDCIDFontType2)
        {
            ...
            if (font != null)
            {
                ...
                {
                    LOG.log(Level.WARNING,"get unicode from font cmap fail", e);
                }
            }
        }
        ...
        if (LOG.isLoggable(Level.WARNING) && !noUnicode.contains(code))
        {
            ...
            LOG.log(Level.WARNING,"No Unicode mapping for " + cid + " (" + code + ") in font " + getName());
