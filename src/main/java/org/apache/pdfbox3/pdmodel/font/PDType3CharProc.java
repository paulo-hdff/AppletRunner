...
{
    private static final Logger LOG = Logger.getLogger(PDType3CharProc.class.getName());
    ...
    public PDResources getResources()
    {
        ...
        {
            // PDFBOX-5294
            LOG.log(Level.WARNING,"Using resources dictionary found in charproc entry");
            LOG.log(Level.WARNING,"This should have been in the font or in the page dictionary");
