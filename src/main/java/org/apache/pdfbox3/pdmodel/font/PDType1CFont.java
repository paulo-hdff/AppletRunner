...
import org.apache.fontbox3.cff.CFFParser;
import org.apache.fontbox3.cff.CFFType1Font;
...
{
    private static final Logger LOG = Logger.getLogger(PDType1CFont.class.getName());
        ...
        if (fd != null)
        {
            ...
            if (ff3Stream != null)
            {
                        ...
                        .createView())
                {
                    ...
                    {
                        LOG.log(Level.SEVERE,"Invalid data for embedded Type1C font " + getName());
                    }
                    else
                    {
                        ...
                        {
                            LOG.log(Level.SEVERE,"Expected CFFType1Font, got "
                ...
                {
                    LOG.log(Level.SEVERE,"Can't read the embedded Type1C font " + getName(), e);
                    fontIsDamaged = true;
                }
            }
        }
    ...
    public final Matrix getFontMatrix()
    {
        if (fontMatrix == null)
        {
            ...
            {
                LOG.log(Level.FINER,"Couldn't get font matrix - returning default value", e);
    ...
    public float getHeight(int code) throws IOException
    {
        ...
        if (!glyphHeights.containsKey(name))
        {
            if (cffFont == null)
            {
                LOG.log(Level.WARNING,"No embedded CFF font, returning 0");
                return 0;
            }
