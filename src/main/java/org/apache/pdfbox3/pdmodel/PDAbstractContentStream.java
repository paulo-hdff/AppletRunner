...
import org.apache.fontbox3.ttf.gsub.CompoundCharacterTokenizer;
import org.apache.fontbox3.ttf.gsub.GsubWorker;
import org.apache.fontbox3.ttf.gsub.GsubWorkerFactory;
...
import org.apache.pdfbox3.pdmodel.graphics.color.PDDeviceCMYK;
import org.apache.pdfbox3.pdmodel.graphics.color.PDDeviceGray;
import org.apache.pdfbox3.pdmodel.graphics.color.PDDeviceN;
...
import org.apache.pdfbox3.pdmodel.graphics.image.PDInlineImage;
...
import org.apache.pdfbox3.util.NumberFormatUtil;
...
{
    private static final Logger LOG = Logger.getLogger(PDAbstractContentStream.class.getName());
    ...
    public void setFont(PDFont font, float fontSize) throws IOException
    {
        ...
        if (font.willBeSubset())
        {
            ...
            {
                LOG.log(Level.WARNING,"Using the subsetted font '" + font.getName() +
                        "' without a PDDocument context; call subset() before saving");
            }
        }
        else if (!font.isEmbedded() && !font.isStandard14())
        {
            LOG.log(Level.WARNING,"attempting to use font '" + font.getName() + "' that isn't embedded");
        }
    ...
    public void close() throws IOException
    {
        if (inTextMode)
        {
            LOG.log(Level.WARNING,"You did not call endText(), some viewers won't display your text");
        }
        outputStream.close();
    }
