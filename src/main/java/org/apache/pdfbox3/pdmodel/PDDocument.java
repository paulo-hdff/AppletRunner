 ...
 */
package org.apache.pdfbox3.pdmodel;
...
import org.apache.pdfbox3.cos.COSDocument;
...
import org.apache.pdfbox3.cos.COSUpdateInfo;
...
import org.apache.pdfbox3.pdfwriter.COSWriter;
import org.apache.pdfbox3.pdfwriter.compress.CompressParameters;
import org.apache.pdfbox3.pdmodel.common.COSArrayList;
import org.apache.pdfbox3.pdmodel.common.PDRectangle;
...
import org.apache.pdfbox3.pdmodel.encryption.SecurityHandlerFactory;
import org.apache.pdfbox3.pdmodel.font.PDFont;
...
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAppearanceDictionary;
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAppearanceStream;
import org.apache.pdfbox3.pdmodel.interactive.digitalsignature.ExternalSigningSupport;
import org.apache.pdfbox3.pdmodel.interactive.digitalsignature.PDSignature;
import org.apache.pdfbox3.pdmodel.interactive.digitalsignature.SignatureInterface;
import org.apache.pdfbox3.pdmodel.interactive.digitalsignature.SignatureOptions;
import org.apache.pdfbox3.pdmodel.interactive.digitalsignature.SigningSupport;
import org.apache.pdfbox3.pdmodel.interactive.form.PDAcroForm;
import org.apache.pdfbox3.pdmodel.interactive.form.PDField;
import org.apache.pdfbox3.pdmodel.interactive.form.PDSignatureField;
...
public class PDDocument implements Closeable
{
    ...
    private static final Logger LOG = Logger.getLogger(PDDocument.class.getName());
    ...
    static
    {
        ...
        {
            LOG.log(Level.FINER,"voodoo error", ex);
        }
    }
    ...
    public PDPage importPage(PDPage page) throws IOException
    {
        ...
        {
            LOG.log(Level.WARNING,"inherited resources of source document are not imported to destination page");
            LOG.log(Level.WARNING,"call importedPage.setResources(page.getResources()) to do this");
        }
        return importedPage;
    }
     ...
     * In PDF 2.0 this is deprecated except for two entries, /CreationDate and /ModDate. For any other
     * document level metadata, a metadata stream should be used instead, see
     * {@link PDDocumentCatalog#setMetadata(org.apache.pdfbox3.pdmodel.common.PDMetadata) PDDocumentCatalog#setMetadata(PDMetadata)}.
     *
     ...
     * <p>
     * If encryption has been activated (with {@link #protect(org.apache.pdfbox3.pdmodel.encryption.ProtectionPolicy)
     ...
     *
     * @see org.apache.pdfbox3.pdmodel.encryption.StandardProtectionPolicy
     * @see org.apache.pdfbox3.pdmodel.encryption.PublicKeyProtectionPolicy
     *
    ...
    public void protect(ProtectionPolicy policy) throws IOException
    {
        ...
        {
            LOG.log(Level.WARNING,"do not call setAllSecurityToBeRemoved(true) before calling protect(), "
    ...
    public float getVersion()
    {
        ...
        if (headerVersionFloat >= 1.4f)
        {
            ...
            if (catalogVersion != null)
            {
                ...
                {
                    LOG.log(Level.SEVERE,"Can't extract the version number of the document catalog.", exception);
                }
            }
    ...
    public void setVersion(float newVersion)
    {
        ...
        {
            LOG.log(Level.SEVERE,"It's not allowed to downgrade the version of a pdf.");
            return;
        }
