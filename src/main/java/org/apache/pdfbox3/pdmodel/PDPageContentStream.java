...
public final class PDPageContentStream extends PDAbstractContentStream implements Closeable
{
    ...
    private static final Logger LOG = Logger.getLogger(PDPageContentStream.class.getName());
    ...
    public PDPageContentStream(PDDocument document, PDPage sourcePage) throws IOException
    {
        ...
        {
            LOG.log(Level.WARNING,"You are overwriting an existing content, you should use the append mode");
        }
    }
