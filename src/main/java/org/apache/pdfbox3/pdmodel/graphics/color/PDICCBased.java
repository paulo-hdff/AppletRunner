 ...
 */
package org.apache.pdfbox3.pdmodel.graphics.color;
...
import org.apache.pdfbox3.pdmodel.ResourceCache;
import org.apache.pdfbox3.pdmodel.common.PDRange;
...
{
    private static final Logger LOG = Logger.getLogger(PDICCBased.class.getName());
    ...
    private PDICCBased(COSArray iccArray) throws IOException
    {
        useOnlyAlternateColorSpace = System
                .getProperty("org.apache.pdfbox3.rendering.UseAlternateInsteadOfICCColorSpace") != null;
        array = iccArray;
    ...
    private void loadICCProfile() throws IOException
    {
        if (useOnlyAlternateColorSpace)
        {
            ...
            {
              LOG.log(Level.WARNING,"Error initializing alternate color space: " + e.getLocalizedMessage());
            }
        }
    ...
    private void fallbackToAlternateColorSpace(Exception e) throws IOException
    {
        ...
        if (e != null)
        {
            LOG.log(Level.WARNING,"Can't read embedded ICC profile (" + e.getLocalizedMessage() +
    ...
    private static ICC_Profile ensureDisplayProfile(ICC_Profile profile)
    {
        if (profile.getProfileClass() != ICC_Profile.CLASS_DISPLAY)
        {
            ...
            {
                LOG.log(Level.WARNING,"ICC profile is Perceptual, ignoring, treating as Display class");
    ...
    public int getNumberOfComponents()
    {
        if (numberOfComponents < 0)
        {
            ...
            if (iccProfile != null)
            {
                ...
                {
                    LOG.log(Level.WARNING,"Using " + numIccComponents + " components from ICC profile info instead of " +
