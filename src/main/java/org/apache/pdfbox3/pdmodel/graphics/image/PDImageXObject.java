...
import org.apache.pdfbox3.cos.COSInputStream;
import org.apache.pdfbox3.cos.COSName;
import org.apache.pdfbox3.cos.COSObject;
import org.apache.pdfbox3.cos.COSStream;
import org.apache.pdfbox3.filter.DecodeOptions;
import org.apache.pdfbox3.filter.DecodeResult;
...
import org.apache.pdfbox3.util.filetypedetector.FileType;
import org.apache.pdfbox3.util.filetypedetector.FileTypeDetector;
...
public final class PDImageXObject extends PDXObject implements PDImage
{
     ...
     * Log instance.
     */
    private static final Logger LOG = Logger.getLogger(PDImageXObject.class.getName());
    ...
    public static PDImageXObject createFromFileByExtension(File file, PDDocument doc) throws IOException
    {
        ...
        if ("tif".equals(ext) || "tiff".equals(ext))
        {
            ...
            {
                LOG.log(Level.FINER,"Reading as TIFF failed, setting fileType to PNG", ex);
    ...
    private float[] extractMatte(PDImageXObject softMask) throws IOException
    {
        ...
        if (base instanceof COSArray)
        {
            ...
            {
                LOG.log(Level.SEVERE,"Image /Matte entry not long enough for colorspace, skipped");
                return null;
            }
    ...
    public String getSuffix()
    {
        ...
        {
            LOG.log(Level.WARNING,"getSuffix() returns null, filters: " + filters);
            return null;
        }
    }
