...
abstract class PDTriangleBasedShadingType extends PDShading
{
    ...
    private static final Logger LOG = Logger.getLogger(PDTriangleBasedShadingType.class.getName());
    ...
    public int getBitsPerComponent()
    {
        if (bitsPerColorComponent == -1)
        {
            ...
            LOG.log(Level.FINER,"bitsPerColorComponent: " + bitsPerColorComponent);
        }
    ...
    public int getBitsPerCoordinate()
    {
        if (bitsPerCoordinate == -1)
        {
            ...
            LOG.log(Level.FINER,"bitsPerCoordinate: " + (Math.pow(2, bitsPerCoordinate) - 1));
        }
    ...
    public int getNumberOfColorComponents() throws IOException
    {
        if (numberOfColorComponents == -1)
        {
            ...
            LOG.log(Level.FINER,"numberOfColorComponents: " + numberOfColorComponents);
        }
                                ...
                                Matrix matrix, AffineTransform xform) throws IOException
    {
        ...
        LOG.log(Level.FINER,"coord: " + String.format("[%06X,%06X] -> [%f,%f]", x, y, dstX, dstY));
        ...
        for (int n = 0; n < numberOfColorComponents; ++n)
        {
            ...
            LOG.log(Level.FINER,"color[" + n + "]: " + color + "/" + String.format("%02x", color)
