...
public final class PDDeviceNAttributes
{
     ...
     * Log instance.
     */
    private static final Logger LOG = Logger.getLogger(PDDeviceNAttributes.class.getName());
    ...
    public String toString()
    {
        ...
        {
            LOG.log(Level.FINER,"Couldn't get the colorants information - returning 'ERROR' instead'", e);
            sb.append("ERROR");
        }
        sb.append('}');
        return sb.toString();
