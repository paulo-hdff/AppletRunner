...
{
    private static final Logger LOG = Logger.getLogger(PDShadingType4.class.getName());
                ...
                try
                {
                    switch (flag)
                    {
                        case 0:
                            ...
                            if (flag != 0)
                            {
                                LOG.log(Level.SEVERE,"bad triangle: " + flag);
                            }
                        ...
                        case 2:
                            ...
                            if (lastIndex < 0)
                            {
                                LOG.log(Level.SEVERE,"broken data stream: " + list.size());
                            }
                            else
                            {
                            ...
                            break;
                        default:
                            LOG.log(Level.WARNING,"bad flag: " + flag);
                            break;
                    }
                }
                catch (EOFException ex)
