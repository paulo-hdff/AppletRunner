...
{
    private static final Logger LOG = Logger.getLogger(Type1ShadingContext.class.getName());
                               ...
                               Matrix matrix) throws IOException
    {
        ...
        {
            LOG.log(Level.SEVERE,ex.getMessage() + ", matrix: " + matrix, ex);
        ...
        for (int j = 0; j < h; j++)
        {
            for (int i = 0; i < w; i++)
            {
                ...
                else
                {
                    ...
                    {
                        LOG.log(Level.SEVERE,"error while processing a function", e);
                        continue;
                    }
                }
                ...
                if (shadingColorSpace != null)
                {
                    ...
                    {
                        LOG.log(Level.SEVERE,"error processing color space", e);
                        continue;
                    }
                }
