...
import org.apache.pdfbox3.pdmodel.common.PDPageLabels;
...
import org.apache.pdfbox3.pdmodel.fixup.AcroFormDefaultFixup;
import org.apache.pdfbox3.pdmodel.fixup.PDDocumentFixup;
import org.apache.pdfbox3.pdmodel.graphics.color.PDOutputIntent;
import org.apache.pdfbox3.pdmodel.graphics.optionalcontent.PDOptionalContentProperties;
import org.apache.pdfbox3.pdmodel.interactive.action.PDActionFactory;
import org.apache.pdfbox3.pdmodel.interactive.action.PDDocumentCatalogAdditionalActions;
import org.apache.pdfbox3.pdmodel.interactive.action.PDURIDictionary;
import org.apache.pdfbox3.pdmodel.interactive.documentnavigation.destination.PDDestination;
import org.apache.pdfbox3.pdmodel.interactive.documentnavigation.destination.PDNamedDestination;
...
import org.apache.pdfbox3.pdmodel.interactive.pagenavigation.PDThread;
...
{
    private static final Logger LOG = Logger.getLogger(PDDocumentCatalog.class.getName());
    ...
    public PDAcroForm getAcroForm(PDDocumentFixup acroFormFixup)
    {
        ...
        {
            LOG.log(Level.FINER,"AcroForm content has already been retrieved with fixes applied - original content changed because of that");
        }
    ...
    public PageMode getPageMode()
    {
        ...
        if (mode != null)
        {
            ...
            {
                LOG.log(Level.FINER,"Invalid PageMode used '" + mode + "' - setting to PageMode.USE_NONE", e);
    ...
    public PageLayout getPageLayout()
    {
        ...
        if (mode != null && !mode.isEmpty())
        {
            ...
            {
                LOG.log(Level.WARNING,"Invalid PageLayout used '" + mode + "' - returning PageLayout.SINGLE_PAGE", e);
            }
        }
