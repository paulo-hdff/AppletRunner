...
public class PDObjectReference implements COSObjectable
{
     ...
     * Log instance.
     */
    private static final Logger LOG = Logger.getLogger(PDObjectReference.class.getName());
    ...
    public COSObjectable getReferencedObject()
    {
        ...
        {
            LOG.log(Level.FINER,"Couldn't get the referenced object - returning null instead", exception);
