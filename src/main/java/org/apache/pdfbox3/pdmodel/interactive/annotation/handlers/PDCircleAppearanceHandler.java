...
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAnnotationCircle;
...
{
    private static final Logger LOG = Logger.getLogger(PDCircleAppearanceHandler.class.getName());
