...
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAnnotationCaret;
...
{
    private static final Logger LOG = Logger.getLogger(PDCaretAppearanceHandler.class.getName());
