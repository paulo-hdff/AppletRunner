...
import org.apache.pdfbox3.pdmodel.PDPageContentStream;
import org.apache.pdfbox3.pdmodel.PDPageContentStream.AppendMode;
...
import org.apache.pdfbox3.pdmodel.fdf.FDFCatalog;
import org.apache.pdfbox3.pdmodel.fdf.FDFDictionary;
import org.apache.pdfbox3.pdmodel.fdf.FDFDocument;
import org.apache.pdfbox3.pdmodel.fdf.FDFField;
...
{
    private static final Logger LOG = Logger.getLogger(PDAcroForm.class.getName());
    ...
    public void flatten() throws IOException
    {
        ...
        if (xfaIsDynamic())
        {
            LOG.log(Level.WARNING,"Flatten for a dynamix XFA form is not supported");
            return;
        }
    ...
    public void flatten(List<PDField> fields, boolean refreshAppearances) throws IOException
    {
        ...
        {
            LOG.log(Level.WARNING,"acroForm.getNeedAppearances() returns true, " +
                     "visual field appearances may not have been set");
            LOG.log(Level.WARNING,"call acroForm.refreshAppearances() or " +
            ...
            List<PDField> fields, PDPageTree pages) throws IOException
    {
        ...
        LOG.log(Level.WARNING,"There has been a widget with a missing page reference, will check all page annotations");
        for (PDPage page : pages)
        {
            for (PDAnnotation annotation : page.getAnnotations())
            {
