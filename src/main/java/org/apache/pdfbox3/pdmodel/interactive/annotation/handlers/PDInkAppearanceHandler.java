...
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAnnotationInk;
...
{
    private static final Logger LOG = Logger.getLogger(PDInkAppearanceHandler.class.getName());
