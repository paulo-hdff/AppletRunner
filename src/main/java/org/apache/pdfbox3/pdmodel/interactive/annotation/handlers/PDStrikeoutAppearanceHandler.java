...
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAnnotationStrikeout;
...
{
    private static final Logger LOG = Logger.getLogger(PDStrikeoutAppearanceHandler.class.getName());
