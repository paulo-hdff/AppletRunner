 ...
 */
package org.apache.pdfbox3.pdmodel.interactive.form;
...
import org.apache.pdfbox3.cos.COSString;
import org.apache.pdfbox3.pdfparser.PDFStreamParser;
import org.apache.pdfbox3.pdfwriter.ContentStreamWriter;
...
import org.apache.pdfbox3.pdmodel.font.PDType3CharProc;
...
import org.apache.pdfbox3.pdmodel.interactive.action.PDAction;
import org.apache.pdfbox3.pdmodel.interactive.action.PDActionJavaScript;
import org.apache.pdfbox3.pdmodel.interactive.action.PDFormFieldAdditionalActions;
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAnnotationWidget;
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAppearanceCharacteristicsDictionary;
import org.apache.pdfbox3.pdmodel.PDAppearanceContentStream;
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAppearanceDictionary;
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAppearanceEntry;
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAppearanceStream;
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDBorderStyleDictionary;
...
{
    private static final Logger LOG = Logger.getLogger(AppearanceGeneratorHelper.class.getName());
        ...
        for (PDAnnotationWidget widget : field.getWidgets())
        {
            ...
            for (COSName fontResourceName : widgetResources.getFontNames())
            {
                try
                {
                    ...
                    {
                        LOG.log(Level.FINER,"Adding font resource " + fontResourceName + " from widget to AcroForm");
                ...
                {
                    LOG.log(Level.WARNING,"Unable to match field level font with AcroForm font", e);
                }
            }
        }
    }
    ...
    public void setAppearanceValue(String apValue) throws IOException
    {
        ...
        for (PDAnnotationWidget widget : field.getWidgets())
        {
            ...
            {
                LOG.log(Level.WARNING,"widget of field " + field.getFullyQualifiedName() + " is a PaperMetaData widget, no appearance stream created");
                continue;
            }
            ...
            if (rect == null)
            {
                ...
                LOG.log(Level.WARNING,"widget of field " + field.getFullyQualifiedName() + " has no rectangle, no appearance stream created");
                continue;
            }
                                           ...
                                           OutputStream output) throws IOException
    {
        try (PDAppearanceContentStream contents = new PDAppearanceContentStream(appearanceStream, output))
        {
            ...
            {
                LOG.log(Level.WARNING,"Font '" + defaultAppearance.getFontName().getName() +
                         "' of field '" + field.getFullyQualifiedName() + 
                         "' contains subsetted font '" + font.getName() + "'");
                LOG.log(Level.WARNING,"This may bring trouble with PDField.setValue(), PDAcroForm.flatten() or " +
                         "PDAcroForm.refreshAppearances()");
                LOG.log(Level.WARNING,"You should replace this font with a non-subsetted font:");
                LOG.log(Level.WARNING,"PDFont font = PDType0Font.load(doc, new FileInputStream(fontfile), false);");
                LOG.log(Level.WARNING,"acroForm.getDefaultResources().put(COSName.getPDFName(\"" +
            ...
            if (font.getFontDescriptor() != null) {
                ...
                LOG.log(Level.FINER,"missing font descriptor - resolved Cap/Descent to " + fontCapHeight + "/" + fontDescent);
    ...
    private float resolveGlyphHeight(PDFont font, int code) throws IOException {
        ...
        if (font instanceof PDType3Font) {
            ...
            LOG.log(Level.WARNING,"Unknown font class: " + font.getClass());
        }
        if (path == null) {
            return -1;
        }
