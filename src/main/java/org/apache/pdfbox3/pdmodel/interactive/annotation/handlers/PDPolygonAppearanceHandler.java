...
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAnnotationPolygon;
...
{
    private static final Logger LOG = Logger.getLogger(PDPolygonAppearanceHandler.class.getName());
