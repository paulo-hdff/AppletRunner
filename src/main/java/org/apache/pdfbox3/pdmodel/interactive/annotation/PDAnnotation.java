...
public abstract class PDAnnotation implements COSObjectable
{
     ...
     * Log instance.
     */
    private static final Logger LOG = Logger.getLogger(PDAnnotation.class.getName());
    ...
    public static PDAnnotation createAnnotation(COSBase base) throws IOException
    {
        ...
        if (base instanceof COSDictionary)
        {
            ...
            else
            {
                ...
                LOG.log(Level.FINER,"Unknown or unsupported annotation subtype " + subtype);
            }
        }
        else
        {
    ...
    public PDAnnotation(COSDictionary dict)
    {
        ...
        {
            LOG.log(Level.WARNING,"Annotation has type " + type + ", further mayhem may follow");
        }
    }
    ...
    public PDRectangle getRectangle()
    {
        ...
        if (rectArray != null)
        {
            ...
            {
                LOG.log(Level.WARNING,rectArray + " is not a rectangle array, returning null");
            }
        }
        return rectangle;
    }
