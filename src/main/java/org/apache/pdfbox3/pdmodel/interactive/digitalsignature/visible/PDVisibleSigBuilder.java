 ...
 */
package org.apache.pdfbox3.pdmodel.interactive.digitalsignature.visible;
...
import org.apache.pdfbox3.pdmodel.graphics.image.LosslessFactory;
...
public class PDVisibleSigBuilder implements PDFTemplateBuilder
{
    ...
    private static final Logger LOG = Logger.getLogger(PDVisibleSigBuilder.class.getName());
