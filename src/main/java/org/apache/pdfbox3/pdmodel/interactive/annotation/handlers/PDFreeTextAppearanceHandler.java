 ...
 */
package org.apache.pdfbox3.pdmodel.interactive.annotation.handlers;
...
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAnnotationFreeText;
import static org.apache.pdfbox3.pdmodel.interactive.annotation.PDAnnotationLine.LE_NONE;
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAppearanceStream;
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDBorderEffectDictionary;
import org.apache.pdfbox3.pdmodel.interactive.annotation.layout.AppearanceStyle;
import org.apache.pdfbox3.pdmodel.interactive.annotation.layout.PlainText;
import org.apache.pdfbox3.pdmodel.interactive.annotation.layout.PlainTextFormatter;
...
{
    private static final Logger LOG = Logger.getLogger(PDFreeTextAppearanceHandler.class.getName());
    ...
    private PDColor extractNonStrokingColor(PDAnnotationFreeText annotation)
    {
        ...
        {
            LOG.log(Level.WARNING,"Problem parsing /DA, will use default black", ex);
        }
        return strokingColor;
    }
    ...
    private void extractFontDetails(PDAnnotationFreeText annotation)
    {
        ...
        {
            LOG.log(Level.WARNING,"Problem parsing /DA, will use default 'Helv 10'", ex);
        }
    }
