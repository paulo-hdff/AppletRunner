...
{
    private static final Logger LOG = Logger.getLogger(PDAnnotationPopup.class.getName());
    ...
    public PDAnnotationMarkup getParent()
    {
        ...
        {
            LOG.log(Level.FINER,"An exception while trying to get the parent markup - ignoring", ioe);
