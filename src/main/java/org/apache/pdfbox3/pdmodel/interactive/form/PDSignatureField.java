...
import org.apache.pdfbox3.pdmodel.interactive.digitalsignature.PDSeedValue;
...
{
	private static final Logger LOG = Logger.getLogger(PDSignatureField.class.getName());
    ...
    void constructAppearances() throws IOException
    {
        ...
        if (widget != null)
        {
            ...
            LOG.log(Level.WARNING,"Appearance generation for signature fields not implemented here. "
