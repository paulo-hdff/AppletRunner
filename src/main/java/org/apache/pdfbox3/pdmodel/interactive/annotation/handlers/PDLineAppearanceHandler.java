...
{
    private static final Logger LOG = Logger.getLogger(PDLineAppearanceHandler.class.getName());
        ...
        try (PDAppearanceContentStream cs = getNormalAppearanceAsContentStream())
        {
            ...
            if (annotation.hasCaption() && !contents.isEmpty())
            {
                ...
                catch (IllegalArgumentException ex)
                {
                    ...
                    LOG.log(Level.SEVERE,"line text '" + annotation.getContents() + "' can't be shown", ex);
                }
