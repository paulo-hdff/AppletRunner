...
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAnnotationHighlight;
...
{
    private static final Logger LOG = Logger.getLogger(PDHighlightAppearanceHandler.class.getName());
