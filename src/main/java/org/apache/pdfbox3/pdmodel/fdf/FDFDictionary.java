...
import org.apache.pdfbox3.pdmodel.common.filespecification.PDFileSpecification;
import org.apache.pdfbox3.pdmodel.common.filespecification.PDSimpleFileSpecification;
...
public class FDFDictionary implements COSObjectable
{
    ...
    private static final Logger LOG = Logger.getLogger(FDFDictionary.class.getName());
            ...
            if (node instanceof Element)
            {
                ...
                switch (child.getTagName())
                {
                    ...
                    case "ids":
                        ...
                        {
                            LOG.log(Level.WARNING,"Error parsing ID entry for attribute 'original' [" + original +
                                    "]. ID entry ignored.", e);
                        }
                        try
                        {
                        ...
                        {
                            LOG.log(Level.WARNING,"Error parsing ID entry for attribute 'modified' [" + modified +
                                    "]. ID entry ignored.", e);
                        }
                        setID(ids);
                        break;
                    case "fields":
                        ...
                        for (int f = 0; f < fields.getLength(); f++)
                        {
                                    ...
                                    && ((Element) currentNode).getTagName().equals("field"))
                            {
                                ...
                                {
                                    LOG.log(Level.WARNING,"Error parsing field entry [" + currentNode.getNodeValue() +
                                            "]. Field ignored.", e);
                                }
                            }
                        }
                    ...
                    case "annots":
                        ...
                        for (int j = 0; j < annots.getLength(); j++)
                        {
                            ...
                            if (annotNode instanceof Element)
                            {
                                ...
                                try
                                {
                                    switch (annotationName)
                                    {
                                        ...
                                        case "underline":
                                            ...
                                            break;
                                        default:
                                            LOG.log(Level.WARNING,"Unknown or unsupported annotation type '" +
                                                    annotationName + "'");
                                            break;
                                    }
                                }
                                ...
                                {
                                    LOG.log(Level.WARNING,"Error parsing annotation information [" +
