...
import org.apache.pdfbox3.util.DateConverter;
...
{
    private static final Logger LOG = Logger.getLogger(FDFAnnotation.class.getName());
    ...
    public FDFAnnotation(Element element) throws IOException
    {
        ...
        {
            LOG.log(Level.FINER,"Error while evaluating XPath expression for richtext contents", e);
        }
    ...
    public static FDFAnnotation create(COSDictionary fdfDic)
    {
        ...
        if (fdfDic != null)
        {
            ...
            {
                LOG.log(Level.WARNING,"Unknown or unsupported annotation type '" + fdfDicName + "'");
            }
        }
        return retval;
    }
