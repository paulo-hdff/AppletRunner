...
{
    private static final Logger LOG = Logger.getLogger(FDFAnnotationInk.class.getName());
    /**
    ...
    public FDFAnnotationInk(Element element) throws IOException
    {
        ...
        {
            LOG.log(Level.FINER,"Error while evaluating XPath expression for inklist gestures", e);
        }
    }
