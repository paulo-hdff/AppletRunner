...
{
    private static final Logger LOG = Logger.getLogger(CurveToReplicateInitialPoint.class.getName());
    ...
    public void process(Operator operator, List<COSBase> operands) throws IOException
    {
        ...
        {
            LOG.log(Level.WARNING,"curveTo (" + point3.x + "," + point3.y + ") without initial MoveTo");
