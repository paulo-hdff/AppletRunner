 ...
 */
package org.apache.pdfbox3.contentstream;

import org.apache.pdfbox3.cos.COSName;
import org.apache.pdfbox3.pdmodel.PDPage;
import org.apache.pdfbox3.pdmodel.graphics.image.PDImage;

import java.awt.geom.Point2D;
import java.io.IOException;
import org.apache.pdfbox3.contentstream.operator.color.SetNonStrokingColor;
import org.apache.pdfbox3.contentstream.operator.color.SetNonStrokingColorN;
import org.apache.pdfbox3.contentstream.operator.color.SetNonStrokingColorSpace;
import org.apache.pdfbox3.contentstream.operator.color.SetNonStrokingDeviceCMYKColor;
import org.apache.pdfbox3.contentstream.operator.color.SetNonStrokingDeviceGrayColor;
import org.apache.pdfbox3.contentstream.operator.color.SetNonStrokingDeviceRGBColor;
import org.apache.pdfbox3.contentstream.operator.color.SetStrokingColor;
import org.apache.pdfbox3.contentstream.operator.color.SetStrokingColorN;
import org.apache.pdfbox3.contentstream.operator.color.SetStrokingColorSpace;
import org.apache.pdfbox3.contentstream.operator.color.SetStrokingDeviceCMYKColor;
import org.apache.pdfbox3.contentstream.operator.color.SetStrokingDeviceGrayColor;
import org.apache.pdfbox3.contentstream.operator.color.SetStrokingDeviceRGBColor;
import org.apache.pdfbox3.contentstream.operator.graphics.AppendRectangleToPath;
import org.apache.pdfbox3.contentstream.operator.graphics.BeginInlineImage;
import org.apache.pdfbox3.contentstream.operator.graphics.ClipEvenOddRule;
import org.apache.pdfbox3.contentstream.operator.graphics.ClipNonZeroRule;
import org.apache.pdfbox3.contentstream.operator.graphics.CloseAndStrokePath;
import org.apache.pdfbox3.contentstream.operator.graphics.CloseFillEvenOddAndStrokePath;
import org.apache.pdfbox3.contentstream.operator.graphics.CloseFillNonZeroAndStrokePath;
import org.apache.pdfbox3.contentstream.operator.graphics.ClosePath;
import org.apache.pdfbox3.contentstream.operator.graphics.CurveTo;
import org.apache.pdfbox3.contentstream.operator.graphics.CurveToReplicateFinalPoint;
import org.apache.pdfbox3.contentstream.operator.graphics.CurveToReplicateInitialPoint;
import org.apache.pdfbox3.contentstream.operator.graphics.DrawObject;
import org.apache.pdfbox3.contentstream.operator.graphics.EndPath;
import org.apache.pdfbox3.contentstream.operator.graphics.FillEvenOddAndStrokePath;
import org.apache.pdfbox3.contentstream.operator.graphics.FillEvenOddRule;
import org.apache.pdfbox3.contentstream.operator.graphics.FillNonZeroAndStrokePath;
import org.apache.pdfbox3.contentstream.operator.graphics.FillNonZeroRule;
import org.apache.pdfbox3.contentstream.operator.graphics.LegacyFillNonZeroRule;
import org.apache.pdfbox3.contentstream.operator.graphics.LineTo;
import org.apache.pdfbox3.contentstream.operator.graphics.MoveTo;
import org.apache.pdfbox3.contentstream.operator.graphics.ShadingFill;
import org.apache.pdfbox3.contentstream.operator.graphics.StrokePath;
import org.apache.pdfbox3.contentstream.operator.markedcontent.BeginMarkedContentSequence;
import org.apache.pdfbox3.contentstream.operator.markedcontent.BeginMarkedContentSequenceWithProperties;
import org.apache.pdfbox3.contentstream.operator.markedcontent.EndMarkedContentSequence;
import org.apache.pdfbox3.contentstream.operator.state.Concatenate;
import org.apache.pdfbox3.contentstream.operator.state.Restore;
import org.apache.pdfbox3.contentstream.operator.state.Save;
import org.apache.pdfbox3.contentstream.operator.state.SetFlatness;
import org.apache.pdfbox3.contentstream.operator.state.SetGraphicsStateParameters;
import org.apache.pdfbox3.contentstream.operator.state.SetLineCapStyle;
import org.apache.pdfbox3.contentstream.operator.state.SetLineDashPattern;
import org.apache.pdfbox3.contentstream.operator.state.SetLineJoinStyle;
import org.apache.pdfbox3.contentstream.operator.state.SetLineMiterLimit;
import org.apache.pdfbox3.contentstream.operator.state.SetLineWidth;
import org.apache.pdfbox3.contentstream.operator.state.SetMatrix;
import org.apache.pdfbox3.contentstream.operator.state.SetRenderingIntent;
import org.apache.pdfbox3.contentstream.operator.text.BeginText;
import org.apache.pdfbox3.contentstream.operator.text.EndText;
import org.apache.pdfbox3.contentstream.operator.text.SetFontAndSize;
import org.apache.pdfbox3.contentstream.operator.text.SetTextHorizontalScaling;
import org.apache.pdfbox3.contentstream.operator.text.ShowTextAdjusted;
import org.apache.pdfbox3.contentstream.operator.text.ShowTextLine;
import org.apache.pdfbox3.contentstream.operator.text.ShowTextLineAndSpace;
import org.apache.pdfbox3.contentstream.operator.text.MoveText;
import org.apache.pdfbox3.contentstream.operator.text.MoveTextSetLeading;
import org.apache.pdfbox3.contentstream.operator.text.NextLine;
import org.apache.pdfbox3.contentstream.operator.text.SetCharSpacing;
import org.apache.pdfbox3.contentstream.operator.text.SetTextLeading;
import org.apache.pdfbox3.contentstream.operator.text.SetTextRenderingMode;
import org.apache.pdfbox3.contentstream.operator.text.SetTextRise;
import org.apache.pdfbox3.contentstream.operator.text.SetWordSpacing;
import org.apache.pdfbox3.contentstream.operator.text.ShowText;
