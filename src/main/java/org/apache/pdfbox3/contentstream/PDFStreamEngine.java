...
import org.apache.pdfbox3.contentstream.operator.state.EmptyGraphicsStackException;
...
import org.apache.pdfbox3.filter.MissingImageReaderException;
import org.apache.pdfbox3.pdfparser.PDFStreamParser;
import org.apache.pdfbox3.pdmodel.MissingResourceException;
...
import org.apache.pdfbox3.pdmodel.font.PDType1Font;
import org.apache.pdfbox3.pdmodel.font.PDType3CharProc;
import org.apache.pdfbox3.pdmodel.font.PDType3Font;
import org.apache.pdfbox3.pdmodel.font.Standard14Fonts.FontName;
...
import org.apache.pdfbox3.pdmodel.graphics.state.PDTextState;
...
{
    private static final Logger LOG = Logger.getLogger(PDFStreamEngine.class.getName());;
    ...
    public void showTextStrings(COSArray array) throws IOException
    {
        ...
        for (COSBase obj : array)
        {
            ...
            {
                LOG.log(Level.SEVERE,"Nested arrays are not allowed in an array for TJ operation: " + obj);
            }
            else
            {
                LOG.log(Level.SEVERE,"Unknown type " + obj.getClass().getSimpleName() +
    ...
    protected void showText(byte[] string) throws IOException
    {
        ...
        if (font == null)
        {
            LOG.log(Level.WARNING,"No current font, will use default");
            font = getDefaultFont();
        }
    ...
    public void setLineDashPattern(COSArray array, int phase)
    {
        if (phase < 0)
        {
            LOG.log(Level.WARNING,"Dash phase has negative value " + phase + ", set to 0");
            phase = 0;
        }
    ...
    public void decreaseLevel()
    {
        ...
        if (level < 0)
        {
            LOG.log(Level.SEVERE,"level is " + level);
        }
    }
}
