 ...
 */
package org.apache.pdfbox3.filter;
...
import org.apache.pdfbox3.io.RandomAccessReadWriteBuffer;
...
public abstract class Filter
{
     ...
     */
    public static final String SYSPROP_DEFLATELEVEL = "org.apache.pdfbox3.filter.deflatelevel";
    ...
    protected COSDictionary getDecodeParams(COSDictionary dictionary, int index)
    {
        ...
        {
            LOG.log(Level.SEVERE,"Expected DecodeParams to be an Array or Dictionary but found " +
