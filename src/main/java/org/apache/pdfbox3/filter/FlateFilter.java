...
final class FlateFilter extends Filter
{
                                         ...
                                         COSDictionary parameters, int index) throws IOException
    {
        ...
        catch (DataFormatException e)
        {
            ...
            LOG.log(Level.SEVERE,"FlateFilter: stop reading corrupt stream due to a DataFormatException");
                ...
                { 
                    ...
                    catch(DataFormatException exception)
                    {
                        if (dataWritten)
                        {
                            ...
                            LOG.log(Level.WARNING,"FlateFilter: premature end of stream due to a DataFormatException");
                            break;
                        }
                        else
                        {
