...
{
    private static final Logger LOG = Logger.getLogger(DCTFilter.class.getName());
        ...
        try (ImageInputStream iis = ImageIO.createImageInputStream(encoded))
        {
            ...
            if ("3".equals(numChannels) || numChannels.isEmpty())
            {
                ...
                catch (IIOException e)
                {
                    ...
                    LOG.log(Level.FINER,"Couldn't read use read() for RGB image - using readRaster() as fallback", e);
            ...
            if (raster.getNumBands() == 4)
            {
                ...
                catch (IIOException | NegativeArraySizeException e)
                {
                    ...
                    LOG.log(Level.FINER,"Couldn't read usíng getAdobeTransform() - using getAdobeTransformByBruteForce() as fallback", e);
    ...
    private String getNumChannels(ImageReader reader)
    {
        ...
        {
            LOG.log(Level.FINER,"Couldn't read metadata - returning empty string", e);
            return "";
        }
    }    
