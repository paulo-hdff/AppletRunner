...
public class XrefTrailerResolver
{
    ...
    /** Log instance. */
    private static final Logger LOG = Logger.getLogger( XrefTrailerResolver.class.getName());
    ...
    public void setXRef( COSObjectKey objKey, long offset )
    {
        ...
        {
            // should not happen...
            LOG.log(Level.WARNING, "Cannot add XRef entry for '" + objKey.getNumber() + "' because XRef start was not signalled." );
            return;
        }
    ...
    public void setTrailer( COSDictionary trailer )
    {
        ...
        {
            // should not happen...
            LOG.log(Level.WARNING, "Cannot add trailer because XRef start was not signalled." );
            return;
        }
    ...
    public void setStartxref( long startxrefBytePosValue )
    {
        ...
        {
            LOG.log(Level.WARNING, "Method must be called only ones with last startxref value." );
            return;
        }
        ...
        if ( curObj == null )
        {
            ...
            LOG.log(Level.WARNING, "Did not found XRef object at specified startxref position " + startxrefBytePosValue );
        ...
        else
        {
            ...
            while ( curObj.trailer != null )
            {
                ...
                if ( curObj == null )
                {
                    LOG.log(Level.WARNING, "Did not found XRef object pointed to by 'Prev' key at position " + prevBytePos );
                    break;
                }
