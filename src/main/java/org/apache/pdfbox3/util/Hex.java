...
package org.apache.pdfbox3.util;
...
{
    private static final Logger LOG = Logger.getLogger(Hex.class.getName());
    ...
    public static byte[] decodeHex(String s)
    {
        ...
        while (i < s.length() - 1)
        {
            ...
            else
            {
                ...
                {
                    LOG.log(Level.SEVERE,"Can't parse " + hexByte + ", aborting decode", ex);
                    break;
                }
                i += 2;
            }
