...
import org.apache.pdfbox3.pdmodel.interactive.annotation.PDAnnotationLink;
    ...
    protected PDDocument createNewDocument() throws IOException
    {
        ...
        if (sourceDocumentInformation != null)
        {
            ...
            for (COSName key : sourceDocumentInformationDictionary.keySet())
            {
                ...
                {
                    LOG.log(Level.WARNING,"Nested entry for key '" + key.getName()
                    ...
                    {
                        LOG.log(Level.WARNING,"/Root and /Info share the same dictionary");
                    }
                    continue;
                }
