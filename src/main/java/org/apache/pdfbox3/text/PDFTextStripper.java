...
import org.apache.pdfbox3.util.IterativeMergeSort;
...
public class PDFTextStripper extends LegacyPDFStreamEngine
{
    ...
    private static final Logger LOG = Logger.getLogger(PDFTextStripper.class.getName());
    ...
    static
    {
        ...
        catch (SecurityException e)
        {
            ...
            LOG.log(Level.FINER,"Couldn't read system properties - using defaults", e);
        }
    ...
    static
    {
        ...
        {
            LOG.log(Level.WARNING,"Could not parse BidiMirroring.txt, mirroring char map will be empty: "
                    + e.getMessage(), e);
        }
    }
