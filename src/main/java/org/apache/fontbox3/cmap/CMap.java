 ...
 */
package org.apache.fontbox3.cmap;
...
public class CMap
{
    private static final Logger LOG = Logger.getLogger(CMap.class.getName());;
    ...
    public String toUnicode(int code, int length)
    {
        ...
        LOG.log(Level.WARNING,"Mappings with more than 2 bytes aren't supported");
        return null;
    }
    ...
    public int readCode(InputStream in) throws IOException
    {
        ...
        if (LOG.isLoggable(Level.WARNING))
        {
            ...
            LOG.log(Level.WARNING,"Invalid character code sequence " + sb + "in CMap " + cmapName);
        }
        ...
        {
            LOG.log(Level.WARNING,"mark() and reset() not supported, " + (maxCodeLength - 1) +
    ...
    void addCharMapping(byte[] codes, String unicode)
    {
        ...
        {
            LOG.log(Level.WARNING,"Mappings with more than 2 bytes aren't supported yet");
        }
