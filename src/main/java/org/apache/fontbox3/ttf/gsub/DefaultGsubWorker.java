...
import org.apache.fontbox3.ttf.GlyphSubstitutionTable;
...
{
    private static final Logger LOG = Logger.getLogger(DefaultGsubWorker.class.getName());;

    @Override
    public List<Integer> applyTransforms(List<Integer> originalGlyphIds)
    {
        LOG.log(Level.WARNING,getClass().getSimpleName() + " class does not perform actual GSUB substitutions. "
