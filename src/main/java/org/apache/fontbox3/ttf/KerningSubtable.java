...
public class KerningSubtable
{
    ...
    public int[] getKerning(int[] glyphs)
    {
        ...
        {
            LOG.log(Level.WARNING,"No kerning subtable data available due to an unsupported kerning subtable version");
        }
        return kerning;
    }
    ...
    private void readSubtable0(TTFDataStream data) throws IOException
    {
        ...
        {
            LOG.log(Level.FINER,"Skipped kerning subtable due to an unsupported kerning subtable version: " + format);
        }
    }
