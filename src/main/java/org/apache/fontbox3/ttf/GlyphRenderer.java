...
class GlyphRenderer
{
    private static final Logger LOG = Logger.getLogger(GlyphRenderer.class.getName());;
    ...
    private void moveTo(GeneralPath path, Point point)
    {
        ...
        {
            LOG.log(Level.FINEST,"moveTo: " + String.format(Locale.US, "%d,%d", point.x, point.y));
        }
    }
    ...
    private void lineTo(GeneralPath path, Point point)
    {
        ...
        if (LOG.isLoggable(Level.FINEST))
        {
            LOG.log(Level.FINEST,"lineTo: " + String.format(Locale.US, "%d,%d", point.x, point.y));
        }
    }
    ...
    private void quadTo(GeneralPath path, Point ctrlPoint, Point point)
    {
        ...
        if (LOG.isLoggable(Level.FINEST))
        {
            LOG.log(Level.FINEST,"quadTo: " + String.format(Locale.US, "%d,%d %d,%d", ctrlPoint.x, ctrlPoint.y,
                    point.x, point.y));
        }
    }
