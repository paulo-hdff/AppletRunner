...
public class KerningTable extends TTFTable
{
    ...
    private static final Logger LOG = Logger.getLogger(KerningTable.class.getName());;
    ...
    void read(TrueTypeFont ttf, TTFDataStream data) throws IOException
    {
        ...
        {
            LOG.log(Level.FINER,"Skipped kerning table due to an unsupported kerning table version: " + version);
        }
        if (numSubtables > 0)
        {
