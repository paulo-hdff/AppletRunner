...
{
    private static final Logger LOG = Logger.getLogger(OpenTypeScript.class.getName());;
    ...
    static
    {
        ...
        {
            LOG.log(Level.WARNING,"Could not parse Scripts.txt, mirroring char map will be empty: "
                    + e.getMessage(), e);
        }
    }
